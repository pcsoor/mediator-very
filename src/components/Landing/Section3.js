  ...
  return (
    <div className='bg--primary'>
        <div className='container mx-auto max-w-[1170px] px-5 pt-10 pb-16'>
            <h2 className='h2 pb-14' id='mediacio-menete'>
                A mediáció menete
            </h2>
            ...
            <div class="lg:flex justify-center justify-between relative steps-container">
                <div class="step-content-wrapper">
                    <div class="step-content flex justify-center flex-col">
                        <div class="flex mb-2">
                            <h3 class="h3">Előzetes konzulátció</h3>
                        </div>
                    ...
                    <div class="step-content flex justify-center flex-col">
                        <div class="flex mb-2">
                            <h3 class="h3">Lehetséges kimenetelek</h3>
                        </div>
                    ...
                    <div class="step-content flex justify-center flex-col">
                        <div class="flex mb-2">
                            <h3 class="h3">Titoktartási kötelezettség</h3>
                        </div>
                ...
                <div class="step-content-wrapper">
                    ...
                    <div class="flex mb-2">
                        <h3 class="h3">Közös mediációs ülés</h3>
                    </div>
                ...
                <div class="hidden lg:block"></div>
                    ...
                    <div class="step-content flex justify-center flex-col">
                        <div class="flex mb-2">
                            <h3 class="h3">Megállapodás írásba foglalása, a feleknek átadása</h3>
                        </div>
